...
\fancyhead[R]{\small Connected Components Detection}
\fancyfoot[C]{\thepage}
...
\begin{center}
	{\LARGE\bfseries Connected Components Detection in Large Scale Graphs\par}
 
	\vspace{0.5cm}

	{\large
	\textbf{Gerasimou Dimitrios} AEM: 10813 \quad and \quad \textbf{Stavrianidis Giannis} AEM: 11065\\
	}
...
\noindent\textbf{Code Availability:} Complete source code, build instructions, and benchmark scripts are available at
\url{https://github.com/dimgerasimou/ConnectedComponents-HW1-ParDis2025}
