...
int cc_count_parallel_cilk(const CSCBinaryMatrix *matrix, const int n_threads);

int cc_count_parallel_pthreads(const CSCBinaryMatrix *matrix, const int n_threads);
